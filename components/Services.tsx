...
import rahivashi from "@/assests/setu/rahivashi.png";
import income from "@/assests/setu/income.png"
import nationlity from "@/assests/setu/nationlity.png";
import ews from "@/assests/setu/ewss.png";
  ...
  const services = [
    {
      ...
      description: [
        { label: t('setuSuvidhaDesc1'), whatsappText: 'राहिवास प्रमाणपत्र', img: rahivashi },
        { label: t('setuSuvidhaDesc2'), whatsappText: 'उत्पन्नाचा दाखला', img: income },
        ...
        { label: t('setuSuvidhaDesc4'), whatsappText: 'वय, राष्ट्रीयता आणि अधिवास प्रमाणपत्र', img: nationlity },
        { label: t('setuSuvidhaDesc5'), whatsappText: 'इडब्ल्यूएस प्रमाणपत्र', img: ews },
      ],
